...
/**
 * @brief Convierte un arreglo de números binarios en su representación decimal.
 *
 * Interpreta el valor decimal haciendo un left shift y un or lógico para cada 
 * bit del arreglo binario.
 *
 * @param vector<int> Arreglo de números binarios.
 * @return unsigned long long Representación decimal del arreglo.
 */
...
/**
 * @brief Genera determinísticamente una solución X al problema 0-1 Knapsack
 * 
